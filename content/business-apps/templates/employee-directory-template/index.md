...
layout = "single"
preview = "https://res.cloudinary.com/daog6scxm/image/upload/v1734521318/cms/new-template-images/Employee_Directory_o2wqmd.gif"
...
In just a few minutes, you can build an effective web app to store and present employee information. Budibase gives you total control over all features and data fields within your company directory.
...
1. **Personal information** like names, locations, and headshots.
...
Our template gives you an effective and secure staff directory, in minutes.
...
Your employee database is the heart of your staff directory. Use a range of data sources, or our internal database to centralize key information. Budibase supports a range of external databases.
...
Our staff directory template gives you the ability to quickly find employees with an intuitive UI. Out of the box, your employee can lookup colleagues by name, title, or department and view relevant search results.

Using the Budibase builder, you can configure your employee directory to search by any field in your database. Let your employees use the exact search fields they need to find and contact colleagues.

![Employee Directory Search Screenshot](https://res.cloudinary.com/daog6scxm/image/upload/v1734521312/cms/new-template-images/Employee_Directory_1_jvn3zc.webp "Employee Directory Search")
...
Quick and efficient communications are key to any modern business. Our directory template offers a seamless UX. 
...
Budibase makes it easy to tailor data exposure and permissions to the needs of individual users. In our template, we use two distinct custom roles to define the actions that users can take. On-the-ground `Employees` can view all records in the directory or update their own, while `HR Managers` can perform full CRUD actions across our app.
...
Like all Budibase tools, our staff directory template is completely open-source. Unlike other directory tools, you’ll have complete control over your platform's design.

Our directory template offers effective functionality straight out of the box. With Budibase, you have the power to maintain your employee directory as you see fit.
...
Grant permissions and data exposure with our visual RBAC editor.

### Flexible hosting

Flexible hosting is at the core of Budibase. Users have the option to self-host their directory tools, or use Budibase Cloud.
...
Security is critical for modern organizations. Protecting your business’ data is a top priority for Budibase. Our open-source design and self-hosting options make Budibase the top choice for security.

Unlike other business app suites, Budibase offers free SSO across all pricing tiers
...
Budibase also offers integrations with a wide variety of external data sources. Utilize MySQL, Postgres, REST APIs, Couch DB, Amazon S3, and a range of other RDBMSs and NoSQL tools. The Budibase platform also supports manual CSV uploads.
