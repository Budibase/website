...
a) for our hosted software offering (where you access our software as a service), or we provide you associated services, which are set out at: [https://budibase.com/terms-of-service;](https://budibase.com/terms-of-service; "https://budibase.com/terms-of-service;") or

b) where you download and use our open-source software without premium features, and you are not on an enhanced liability package. In that case we provide such open-source software under open-source terms, which are set out at: [https://github.com/Budibase/budibase/blob/develop/LICENSE.](https://github.com/Budibase/budibase/blob/develop/LICENSE. "https://github.com/Budibase/budibase/blob/develop/LICENSE.") If you have downloaded our open-source software on that basis, but require services for that software, the terms in Part 2 below shall apply, but this Part 1 will not apply.

1\.3 These terms are published on our website and you should save a copy of for your records. We may amend them from time to time by publishing a new version on our website. Any changes will not apply retrospectively to software you have already downloaded. This version two of these terms was published on \[ September 2022\] \[Note: TBC\]. You can obtain historic versions by contacting us.
...
3\.4 BB does not impose seat limitations on the number of authorised users you may create under your licence. However, you must act reasonably and in good faith in exercising these rights, and all authorised users must meet the proper criteria and definition for authorised users under these terms, including that they must be using the source-available software for the purpose. You should also note that any authorised user accessing their account where you have paid for source-available software will utilise a credit and you will be responsible for paying for their excess use.
...
5\.2 When you subscribe for premium features, regardless of the tier, you will be required to purchase pre-defined numbers of credits (credits). Each credit permits any authorised users access to the self-hosted software with all premium features within your chosen access tier for one day. Credits are personal to you, and whilst they can be used by any of your authorised users, they cannot be transferred or gifted to third parties.

5\.3 When an authorised user accesses the self-hosted software on any given Day, regardless of how long they use it for, this will utilise one credit. There will be no automatic notifications or prompts to inform an authorised user when that Day is about to expire, and an additional credit will be required. An authorised user may log in and out of the self-hosted software as many times as they want that day without utilising additional credits.

5\.4 Credits expire at the end of each month (even where you have opted for a year’s initial term), meaning that any credits you don’t use during the applicable month will not roll over into future months, other than in exceptional circumstances where BB may facilitate this. If the agreement is terminated early for any reason your unused credits will also expire immediately. There will be no refund or payment for any unused credits either at any month end or on termination or expiry of the agreement.

5\.5 When your cycle renews for the next month, you will automatically receive its new allotment of credits for that month, and previous credits will not roll over into that month.

5\.6 All credits are non-refundable, non-cancellable, non-transferable and non-exchangeable, have no cash value and are not redeemable for cash or anything else.

5\.7 You may from time to time during the subscription term, purchase additional credits (if that option is available within its current access tier - some access tiers will require you to upgrade to a higher tier to obtain additional credits) or upgrade (or downgrade, as further specified in clause 5.8 below) your access tier. This can be done through a separate checkout process via your account, or for enterprise customers, may be agreed through a separate written proposal. The agreement will apply to all your licences, credits or self-hosted software that you activate accordingly.

5\.8 You shall pay to BB the relevant charges for such enhanced access and, if any upgrade, additional credits, or additional licences, are purchased by you part-way through the initial term or any renewal period (as applicable), to the extent that they form part of a premium feature,, such increased charges may be pro-rated for the remainder of the initial term or then current renewal period (as applicable), or part thereof.

5\.9 If you wish to downgrade your access tier, this can be done at any time, and your account on the self-hosted software will be credited with a pro-rated discount to reflect its reduced access over the remainder of the then current initial term or renewal period (as the case may be), based on BB’s reasonable and good faith calculations. Such calculations are final and conclusive and may not be challenged. Any such credit can be used to offset future charges payable by you for premium features or services, but for clarity is non-refundable, non-transferable non-exchangeable, has no cash value and is not redeemable for cash or anything else. If not utilised by you such credit may expire at any point from the end of the then current initial term or renewal period.
...
17\.1 **authorised users** means your company’s employees, representatives, consultants, contractors, or agents only, who are authorised by you and issued a licence key to download and use the source-available software for the purpose;
...
**commencement date** means, as applicable, the start date for your licence to the source-available software, or the provision of the services, as specified in the proposal or during the checkout process;

**credits** has the meaning given to it in clause 5.2;

**Day** means a calendar day, assessed by reference to UTC time. Otherwise a reference to a **day** (lower case) is to a calendar day assessed by reference to UK time; **Daily** and **daily** shall be construed accordingly;
...
**payment terms** means the payment terms for payment of any charges. These shall require consultancy charges being paid up-front in advance (based on allocated time for specified consultancy services), and any relevant licence fee for premium features being paid monthly or yearly in advance based on the initial term selected by you during the checkout process or within a written proposal;
...
**premium features** means any premium features of the self-hosted BB software which we do not make available on an open-source basis;
...
**renewal period** means successive rolling terms (each the same length as the agreed initial term) for the source-available software (or specific premium features) or services you have subscribed for;
...
**specification** means the document detailing the specification of the source-available software set out at [https://budibase.com/self-host-specification](https://budibase.com/self-host-specification "https://budibase.com/self-host-specification");
...
**tier** means a subscription tier for access to the source-available software. Different subscription tiers allow your authorised users access to different premium features and also require you to purchase different minimum numbers of credits. Current access tiers, the premium features available under each, and the minimum numbers of credits required under each, will be specified during the checkout process or in any written proposal for enterprise customers;
...
**trademark** means trademarks (registered or unregistered), service marks, and similar rights, in words or pictures; and
