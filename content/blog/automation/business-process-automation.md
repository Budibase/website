...
Naturally, the specific actions required for each of these depend on the type of resource in question.
...
Say we had a set of letters and policies that customers can download from a dedicated portal app. We might use templates to create these and create automations so that if the customers’ detail change, relevant fields in the documents are also updated.
...
Of course, you can also build your interfaces from scratch. Our low-code platform offers a variety of incredible design tools and pre-built components for you to choose from.
