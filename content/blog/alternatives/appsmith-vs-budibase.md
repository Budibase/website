...
Even better, we’ve got a huge array of dedicated connectors for relational databases, NoSQL tools, and APIs. You can even interact with tabular in Budibase’s data section using the exact same spreadsheet-style grid.
...
OIDC-based SSO is free for all Budibase users, making it the ideal solution for teams of all sizes to build performant apps without compromising on security.
