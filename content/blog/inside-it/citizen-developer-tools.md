...
![](https://lh6.googleusercontent.com/51LHQeA0X1pclSGcaKL6mujB3eczscr0Gj7SywKRCh_nwNKqIyO15lCrQBeNu2Pz22Jz_6fp8V_FircG9MU24ypw8Y9PmQ_8WRPoras6-M_lN0pm_8gD2wPR7XmVipz8GaU1kvgNP4313bmpdmLAqorSqUInRPaxOuZ-4TAXIrzAYjvxyjkAHs3fjQ =624x351)

_(_[_Gartner_](https://www.gartner.com/en/documents/3970067)_)_

So, citizen developer tools normally fall under the umbrella of app-builders, automation platforms, or even just specific customization features within existing SaaS tools.
...
One way of thinking about this is that the purpose of citizen developer software is to make it faster and easier to build specific kinds of solutions.
...
For example, you couldn’t hand the tools your specialist developers use to one of their operations team colleagues and expect effective results. So, we need to understand the distinction between these different kinds of tools.

### How does citizen developer software differ from traditional development tools?

In traditional software development, the developer themself does most of the heavy lifting. There’ll always be a degree of reusability for things like components and basic functions, but in general, traditional development means building tools from scratch.

For citizen developers, this isn’t really an option.

As in, it’s unlikely that many non-specialists would have the skills to build custom tools from the ground up. Instead, the focus shifts to offering streamlined, user-friendly development experiences, to make building mission-critical apps as easy as possible.
...
![](https://lh3.googleusercontent.com/SEwIHxNMe8Cp_q_fJe9ShOToBKj5129zKq8ZxaRyY5LQr1aFmy7agDM03YNZbAjGIB3icxOzTUNBp0Ca6FUrJD6pk8NuM1Hx9d5XTQBK-oBIK8oHHK6eou1_QgwTNGQNEGJGTjkcWHZo_01_kQ_zVAi-snUIfXa5dcGuZ5KNxXOLi24SuK36P75tWQ =624x351)
...
Finally, we have low-code tools. For most businesses, low-code is synonymous with citizen development. Essentially, these are app-building tools that focus on empowering developers of all abilities to build custom tools faster, with less manual intervention.
...
![](https://lh6.googleusercontent.com/ezoIhgJOyGirzCrklvpUVuxDNDnA930EfuyNmr7fNPh8n308F4hjqlAxwx2zIHma9wDdVtQHoNIgosCvszaK2ivOmp0ZZudxXReBjYN3xhry3QwVwN4zptY7IykL6LE1T3VFcgSc3u-4Qmg-a0fRMuVwxeM2LKSc9waURtY8ztJV945Wa8vk9BOyJw =624x351)
...
![](https://lh4.googleusercontent.com/U_8hVtx2qEu5MQLwheErorUxZMcQjlZQ72eGsnK3pgqVrmIZWGoFk4rvrlU6ZwJpY_h2znvFG8SVqM1AL8SoHFPxhAXb-FIMRYGdaXkjbltc4B2Ss_A-CD2TVlqAwcKzTm6LWCERtkmcPWJ5e_Ys9btBXYcl5ESzZuid88ILIqL5DOLdVQ30onJi-A =624x351)
