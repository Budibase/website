...
![Custom SQL GUI](https://res.cloudinary.com/daog6scxm/image/upload/v1664187961/cms/01_scfb6k.png "Custom SQL GUI")
...
![SQL GUI home screens](https://res.cloudinary.com/daog6scxm/image/upload/v1664187936/cms/02_gfitiy.png "SQL GUI home screen")
...
![App settings](https://res.cloudinary.com/daog6scxm/image/upload/v1664187918/cms/03_aux7st.png "App settings")
...
![App settings table](https://res.cloudinary.com/daog6scxm/image/upload/v1664187832/cms/04_rsrtrq.png "App settings table")
...
![Add screens](https://res.cloudinary.com/daog6scxm/image/upload/v1664187812/cms/05_kevrex.png "Add screens")

Then select the “Autogenerated screens” option and pick the _app_settings_ table.

![CRUD screens for SQL GUI](https://res.cloudinary.com/daog6scxm/image/upload/v1664187730/cms/06_qrg0gs.png "CRUD Screen for SQL GUI")

This is what you should see:

![SQL GUI Design](https://res.cloudinary.com/daog6scxm/image/upload/v1664187631/cms/07_qlladj.png "SQL GUI Design")
...
![App theme](https://res.cloudinary.com/daog6scxm/image/upload/v1664187614/cms/08_pmz7kh.png "App theme")
...
![Build a SQL GUI](https://res.cloudinary.com/daog6scxm/image/upload/v1664187551/cms/09_q1hjlr.png "Build a SQL GUI")
...
![SQL GUI](https://res.cloudinary.com/daog6scxm/image/upload/v1664187521/cms/10_qazb43.png "SQL GUI")

Lastly, there’s the delete query. Here is the setup for it:  
![Custom SQL Query](https://res.cloudinary.com/daog6scxm/image/upload/v1664187487/cms/11_nqecxa.png "Custom SQL Query")
...
![SQL GUI component tree](https://res.cloudinary.com/daog6scxm/image/upload/v1664187459/cms/12_t5vrf3.png "SQL GUI component tree")
...
![Table Picker](https://res.cloudinary.com/daog6scxm/image/upload/v1664187441/cms/13_yhi5b9.png "Table picker")
...
![Button Action](https://res.cloudinary.com/daog6scxm/image/upload/v1664187421/cms/14_ld1jtu.png "Button Action")
...
![Query bindings](https://res.cloudinary.com/daog6scxm/image/upload/v1664187342/cms/15_bh6qmx.png "Dynamic filter bindings")

Now you can add a dynamic filter so users can view only what they want from that table.

The next component is the “_add new_” button. It is a simple button that has a “_navigate to_” action when users click on it:![Button Action](https://res.cloudinary.com/daog6scxm/image/upload/v1664187322/cms/16_upu9dp.png "Button action")
...
![SQL GUI screenshot](https://res.cloudinary.com/daog6scxm/image/upload/v1664187298/cms/17_thbhzg.png "SQL GUI screenshot")
...
![How to Build a SQL GUI](https://res.cloudinary.com/daog6scxm/image/upload/v1664187273/cms/18_wjuetf.png "How to build a sql GUI")
