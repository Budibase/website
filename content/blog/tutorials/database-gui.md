...
![How to build a database GUI](https://res.cloudinary.com/daog6scxm/image/upload/v1664186537/cms/01_jx8aut.png "How to build a database GUI")
...
![Add button](https://res.cloudinary.com/daog6scxm/image/upload/v1664186519/cms/02_blui9t.png "Add button")

In the custom query screen you can run your own queries if you want. You can also save them for later use or run queries that were saved.![Database GUI](https://res.cloudinary.com/daog6scxm/image/upload/v1664186501/cms/03_ckradq.png "Database GUI")

This is the form to edit your rows or add new entries. This form automatically loads the table columns as fields.

![Database GUI](https://res.cloudinary.com/daog6scxm/image/upload/v1664186483/cms/04_e8yqk4.png "Database GUI")
...
![Autogenerated Screens](https://res.cloudinary.com/daog6scxm/image/upload/v1664186460/cms/05_oz8mff.png "Autogenerated Screens")
...
![How to build a database GUI](https://res.cloudinary.com/daog6scxm/image/upload/v1664186389/cms/06_bqepv6.png "Database GUI")
...
![Show tables](https://res.cloudinary.com/daog6scxm/image/upload/v1664186144/cms/07_r06rh9.png "Show tables")
...
![MySQL Query](https://res.cloudinary.com/daog6scxm/image/upload/v1664186122/cms/08_rwe2mf.png "MySQL Query")
...
![Set home screen](https://res.cloudinary.com/daog6scxm/image/upload/v1664186044/cms/09_s0hbxp.png "Set home screen")
...
![Component Tree](https://res.cloudinary.com/daog6scxm/image/upload/v1664186026/cms/10_dwg2h5.png "Component Tree")
...
![Show tables](https://res.cloudinary.com/daog6scxm/image/upload/v1664186010/cms/11_megq5f.png "Show tables")
...
![Database GUI screengrab](https://res.cloudinary.com/daog6scxm/image/upload/v1664185988/cms/12_xd3jod.png "Database GUI screengrab")
...
![Low-code database GUI](https://res.cloudinary.com/daog6scxm/image/upload/v1664185970/cms/13_dbvf0r.png "Database GUI")
...
![Database GUI screenshot](https://res.cloudinary.com/daog6scxm/image/upload/v1664185866/cms/14_g5zbeo.png "Database GUI screenshot")

Let’s get started then. Add your form and inside of it add a data provider component. It loads the execute command with the _{{ State.query }}_ binding.![Add form](https://res.cloudinary.com/daog6scxm/image/upload/v1664185842/cms/15_nx9xy6.png "Add form")
...
![Text field](https://res.cloudinary.com/daog6scxm/image/upload/v1664185819/cms/16_qrd3zi.png "Text field")
...
![define button action](https://res.cloudinary.com/daog6scxm/image/upload/v1664185794/cms/17_tuqr3m.png "Define button action")

After the app state is saved, it refreshes the table data.

The _Save Query_ button has these actions:

![Database GUI save query](https://res.cloudinary.com/daog6scxm/image/upload/v1664185773/cms/18_y1xpcr.png "Database GUI save query")
...
![App State](https://res.cloudinary.com/daog6scxm/image/upload/v1664185723/cms/19_cbcge0.png "App state")
...
![How to Build a database GUI component tree](https://res.cloudinary.com/daog6scxm/image/upload/v1664185642/cms/20_jmtanv.png "How to build a database GUI component tree")
