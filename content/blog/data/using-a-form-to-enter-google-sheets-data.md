...
![Create your app](https://res.cloudinary.com/daog6scxm/image/upload/v1661164919/cms/Screenshot_2022-08-10_at_09.45.37_x9oh7p.png "Create your app")
...
![Google Sheets Data Connector](https://res.cloudinary.com/daog6scxm/image/upload/v1661164874/cms/Screenshot_2022-08-10_at_09.52.24_n2fcx7.png "Google Sheets Data Connector")
...
![Google Sheets Data UI](https://res.cloudinary.com/daog6scxm/image/upload/v1661164837/cms/Screenshot_2022-08-10_at_13.10.47_pigqct.png "Google Sheets Data UI")

For context, our spreadsheet looks like this:

![Google Sheets Data](https://res.cloudinary.com/daog6scxm/image/upload/v1661164796/cms/Screenshot_2022-08-10_at_09.58.54_lbgev4.png "Google Sheets Data")
...
![Generate Screens](https://res.cloudinary.com/daog6scxm/image/upload/v1661164628/cms/Screenshot_2022-08-10_at_13.32.24_yh7plu.png "Generate Screens")
...
![Create CRUD Screens](https://res.cloudinary.com/daog6scxm/image/upload/v1661164581/cms/Screenshot_2022-08-10_at_13.33.39_v4cjf0.png "Create CRUD Screens")
...
![Google Sheets CRUD App](https://res.cloudinary.com/daog6scxm/image/upload/v1661164519/cms/Screenshot_2022-08-10_at_10.00.54_tewyph.png "Google Sheets CRUD App")

Each row has a link with the anchor text ‘_View’_. Users can click on this to access the _Update_ form:

![Google Sheets Update Form](https://res.cloudinary.com/daog6scxm/image/upload/v1661164486/cms/Screenshot_2022-08-10_at_10.01.05_vkxqnl.png "Google Sheets Update Form")

And finally, we also have a form for creating new entries:

![Form to enter Google Sheets data](https://res.cloudinary.com/daog6scxm/image/upload/v1661164452/cms/Screenshot_2022-08-10_at_10.01.13_ecm02q.png "Form to enter Google Sheets data")
...
![Test form](https://res.cloudinary.com/daog6scxm/image/upload/v1661164371/cms/Screenshot_2022-08-10_at_10.03.31_snbyjy.png "Test form")

Hit _Save_ and head back to your spreadsheet to confirm the change has been made:

![Test form data in Google Sheets](https://res.cloudinary.com/daog6scxm/image/upload/v1661164341/cms/Screenshot_2022-08-10_at_10.03.48_sllevv.png "Test form data")
...
![Manage data RBAC](https://res.cloudinary.com/daog6scxm/image/upload/v1661164292/cms/Screenshot_2022-08-10_at_14.22.58_bizjsy.png "Manage data access")
...
![Create form for Google Sheets](https://res.cloudinary.com/daog6scxm/image/upload/v1661164245/cms/Screenshot_2022-08-10_at_10.01.13_xxbwfx.png "Create form for Google Sheets")

And we can quickly change the others to _Basic_:

![Set screen roles](https://res.cloudinary.com/daog6scxm/image/upload/v1661164208/cms/Screenshot_2022-08-10_at_10.01.41_w7xi5r.png "Set screen roles")
...
![Set as home screen](https://res.cloudinary.com/daog6scxm/image/upload/v1661164121/cms/Screenshot_2022-08-10_at_10.04.23_y4lqjk.png "Set as home screen")
...
![Hide navigation](https://res.cloudinary.com/daog6scxm/image/upload/v1661164057/cms/Screenshot_2022-08-10_at_14.51.33_cgkdrr.png "Hide navigation")

Now, when a public user lands on the app, they’ll see the form, but they’ll have no way of navigating to any other screens:

![Auto generated form](https://res.cloudinary.com/daog6scxm/image/upload/v1661164020/cms/Screenshot_2022-08-10_at_14.54.24_mxlxta.png "Auto generated form")
...
![App theme](https://res.cloudinary.com/daog6scxm/image/upload/v1661163993/cms/Screenshot_2022-08-10_at_14.59.39_tlahof.png "App theme")
...
![Button color](https://res.cloudinary.com/daog6scxm/image/upload/v1661163946/cms/Screenshot_2022-08-10_at_15.01.15_pnagqg.png "Button color")
...
![Remove breadcrumbs](https://res.cloudinary.com/daog6scxm/image/upload/v1661163735/cms/Screenshot_2022-08-10_at_15.02.16_ryvm3o.png "Remove breadcrumbs")

Then we’ll add a bit of margin to the top of our form:

![Margin](https://res.cloudinary.com/daog6scxm/image/upload/v1661163707/cms/Screenshot_2022-08-10_at_15.08.32_kgv74t.png "Margin")
...
![Using a form to enter Google Sheets Data](https://res.cloudinary.com/daog6scxm/image/upload/v1661163657/cms/Screenshot_2022-08-10_at_15.09.18_x6wwjj.png "Using a form to enter Google Sheets Data")
...
![Form Header](https://res.cloudinary.com/daog6scxm/image/upload/v1661163632/cms/Screenshot_2022-08-10_at_15.12.02_hwfmlx.png "Form header")
...
![Adjust labels](https://res.cloudinary.com/daog6scxm/image/upload/v1661163606/cms/Screenshot_2022-08-10_at_15.14.29_o36svh.png "Adjust labels")
...
![Improve form UX](https://res.cloudinary.com/daog6scxm/image/upload/v1661163572/cms/Screenshot_2022-08-10_at_15.17.34_lhubab.png "Improve form UX")

Et voila! We now have a clean, professional-looking form to enter data to Google Sheets:

![App preview](https://res.cloudinary.com/daog6scxm/image/upload/v1661163486/cms/Screenshot_2022-08-10_at_15.19.29_fa1pcw.png "APp preview")

It even looks great on mobile:

![Using a form to enter Google Sheets Data](https://res.cloudinary.com/daog6scxm/image/upload/v1661163455/cms/Screenshot_2022-08-10_at_15.20.08_w4yroq.png "Using a form to enter Google Sheets Data")
...
![Home Screen](https://res.cloudinary.com/daog6scxm/image/upload/v1661163424/cms/Screenshot_2022-08-10_at_15.23.34_by7dvl.png "Home screen")
...
![Data bindings](https://res.cloudinary.com/daog6scxm/image/upload/v1661163368/cms/Screenshot_2022-08-10_at_15.27.03_xqzjzs.png "Data bindings")

We’ll also change the _Create New_ button to the _Action_ variant again. Now our app looks like this:

![](https://res.cloudinary.com/daog6scxm/image/upload/v1661163232/cms/Screenshot_2022-08-10_at_15.28.33_n1bo5o.png)
...
![Using a form to enter Google Sheets Data](https://res.cloudinary.com/daog6scxm/image/upload/v1661163173/cms/Screenshot_2022-08-10_at_15.29.36_vjzp0j.png "Using a form to enter Google SHeets data")

This gives your team a simple way to create complex filters for finding specific data:

![Dynamic filter](https://res.cloudinary.com/daog6scxm/image/upload/v1661163149/cms/Screenshot_2022-08-10_at_15.31.54_sd1gwo.png "Dynamic filter")
